...
#ifdef _WIN32
#define QNN_UNUSED_API
#else
#define QNN_UNUSED_API __attribute__((unused))
#endif
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_initialize(
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_getInfo(
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_validateOpConfig(
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_createOpImpl(
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_freeOpImpl(
    QnnOpPackage_OpImpl_t operation) {
  if (!sg_opPackage) {
    return QNN_OP_PACKAGE_ERROR_LIBRARY_NOT_INITIALIZED;
  }
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_terminate() {
  sg_opPackage.reset();
  return QNN_SUCCESS;
}

QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_logInitialize(
...
QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_logSetLevel(
    QnnLog_Level_t maxLogLevel) {
  return QNN_SUCCESS;
}

QNN_UNUSED_API static Qnn_ErrorHandle_t QnnOpPackage_logTerminate(void) {
  return QNN_SUCCESS;
}
