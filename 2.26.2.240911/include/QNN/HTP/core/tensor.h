...
class Tensor {
  public:
    ...
    API_EXPORT virtual const size_t max_dim(size_t index) const noexcept = 0;
    API_EXPORT virtual std::pair<size_t const *, size_t>
...
class FakeTensor : public Tensor {
  ...
  public:
    ...
    API_EXPORT virtual const size_t max_dim(size_t index) const noexcept override; //->0
...
template <unsigned TRank> class TensorShape : public RankedTensor<TRank> {
  ...
  public:
    ...
    API_EXPORT virtual const size_t max_dim(size_t index) const noexcept override final { return dim(index); }
...
template <DType DT> class TensorSclrDT : public Tensor {
  ...
  public:
    ...
    API_EXPORT virtual const size_t dim(size_t index) const noexcept override { return 1; }
    API_EXPORT virtual const size_t max_dim(size_t index) const noexcept override
    {
        return 1;
...
template <typename Linfo> class LayoutTensor : public RankedTensor<Linfo::Rank> {
  ...
  public:
    ...
    API_EXPORT virtual const inline size_t max_dim(size_t index) const noexcept override final
    {
